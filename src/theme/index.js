...
export default {
  ...
  colors: {
    ...
    '$gradient-vector-grey': 'linear-gradient(115.06deg, #E5E5E5 0%, rgba(245, 245, 245, 0) 100%)',
  ...
  spacing: {
    ...
    '$pokemon-list-height': `${7.188 - (defaultSpacing * 4)}rem`,
    '$pokemon-list-padding': `${defaultSpacing * 2}rem`,
    '$pokemon-list-radius': `${defaultSpacing}rem`,
  },
  transitions: {
